...
const MovieEdit=({movie,movies,setMovies})=>{
...
return(
    <>
                <i class="fa-solid fa-pen-to-square fa-2xl" onClick={handleShow} style={{marginLeft: '43px'}}></i>
                ...
                <Modal show={show} onHide={handleClose}>
                    ...
                    <Form.Group className="mb-3" controlId="formBasicEmail">
                        ...
                        <br/>
                        <Rating name="simple-controlled" onChange={(e)=> setRating(e.target.value)} value={rating}/>   

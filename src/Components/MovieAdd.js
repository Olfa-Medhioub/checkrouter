...
return(
    <>
                <i class="fa-solid fa-plus fa-2xl" onClick={handleShow} style={{marginLeft: '43px'}}></i>
        ...
        //  <div>
        //   <input type='text' onChange={(e)=>setMovies(e.target.value)}/>
        //   <button onClick={()=>{handleAdd({title, description, posterURL , rating, id : Math.random()})}}>Add</button>
        //   </div>
)
}
